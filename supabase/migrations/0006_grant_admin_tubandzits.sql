-- Grant admin to tubandzits@gmail.com (existing + future signups).

update public.profiles
set is_admin = true
where lower(email) = 'tubandzits@gmail.com';
...
begin
  ...
  insert into public.profiles (id, email, full_name, first_name, last_name, referral_code, referred_by, is_admin)
  values (
    new.id,
    new.email,
    full_display,
